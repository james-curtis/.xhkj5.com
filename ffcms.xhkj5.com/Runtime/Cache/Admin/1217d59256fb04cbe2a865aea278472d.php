...
<script>var version="<?php echo L("feifeicms_version");?>";</script>
</head>
<body>
<center>
<div id="nifty">
...
<div style="width:401px !important; width:403px; height:30px; background:#F7F7E7; border:1px solid #649EB2; border-top:1px solid #ddd; margin-bottom:5px; font-size:12px; line-height:30px; font-family:'微软雅黑'" id="tips">@2006-2014 FeiFeiCms <?php echo L("feifeicms_version");?></div>
<b class="rbottom"><b class="r4"></b><b class="r3"></b><b class="r2"></b><b class="r1"></b></b>
</div>
<h4><a href="http://cdn.feifeicms.co/server/v3/jump.php?version=<?php echo L("feifeicms_version");?>" target="_blank">点击访问《飞飞影视导航系统》帮助中心</a></h4>
</center>
<span style="display:none"><script type="text/javascript" src="http://cdn.feifeicms.co/server/v3/tongji.js"></script></span>
</body>
</html>