...
<div class="page-header">
  <h2 class="text-nowrap">
    ...
    <small class="hidden-xs hidden-sm"><include file="Base:vod_share" /></small>
  </h2>
</div>
<div class="row ff-row">
  <div class="col-md-8 ff-col">
    ...
    <ul class="list-unstyled ff-row ff-player-tool">
      <li class="col-sm-4 col-xs-7 ff-col"><include file="Base:vod_updown" /></li>
      <li class="col-sm-4 hidden-xs"><include file="Base:vod_score" /></li>
      <li class="col-sm-4 col-xs-5 ff-col text-right"><include file="Base:vod_playurl_next" /></li>
    </ul>
  </div>
    ...
    <div class="media">
      ...
      <div class="media-body">
        ...
        <dl class="dl-horizontal">
          ...
          <dt>地区：</dt>
          <dd class="text-nowrap"><include file="Base:vod_area" /></dd>
          <dt>年份：</dt>
