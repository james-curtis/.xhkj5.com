...
class ApiAction extends HomeAction{
	...
	public function news(){
		//默认定义
		$params = array();
		$params['field'] = 'list_name,news_id,news_cid,news_name,news_ename,news_type,news_keywords,news_pic,news_pic_bg,news_pic_slide,news_inputer,news_reurl,news_remark,news_content,news_hits,news_stars,news_up,news_down,news_jumpurl,news_letter,news_gold,news_golder';
		//获取地址栏参数
