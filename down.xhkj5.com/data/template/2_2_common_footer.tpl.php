...
<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?>
            ...
            <p>
            	Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?>
&nbsp;&nbsp;&copy; 2001-2013 <a href="http://www.ymg6.com" target="_blank">Comsenz Inc.</a>&nbsp;&nbsp;源码哥分享吧  ICP证:粤ICP备13026616号  增值电信业务经营许可证：粤B2-20140196
            </p>
        </div>
    </div>
    
<div id="ft" style="margin:0;padding:0; height:0; border-top:0;"><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
