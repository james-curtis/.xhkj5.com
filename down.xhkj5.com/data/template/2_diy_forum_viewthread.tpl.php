...
0
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/ymg6.com_1490552828/forum/viewthread_node.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/ymg6.com_1490552828/forum/viewthread_fastpost.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/default/common/seditor.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/default/common/upload.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/viewthread.htm', './template/default/common/seccheck.htm', 1521213734, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/viewthread')
;
block_get('35,33,34');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<div id="pt" class="bm cl">
        <div class="z">
            <a href="./" class="nvhm" title="首页"></a><em>&raquo;</em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
        </div>
    </div>
...
<div class="deanluntan_view">
    	<!--版块介绍-->
            <div class="deanbkjs">
            	<div class="deanjstop">
                	<div class="deanjstopl"><?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="data/attachment/common/<?php echo $_G['forum']['banner'];?>" alt="data/attachment/common/<?php echo $_G['forum']['name'];?>" /><?php } ?></div>
                    <div class="deanjstopr">
                    	<h3><a class="deanbkname" href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a></h3>
                        <div class="deanjsbottom">
                            <ul>
                                <span>今日:</span><span><?php echo $_G['forum']['todayposts'];?></span><em>|</em>
                                <span>主题:</span><span><?php echo $_G['forum']['threads'];?></span>
                                <div class="clear"></div>
                            </ul>
                        </div>
                        <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum" id="a_favorite" class="deansc" title="收藏本版" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <strong class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</strong></a>
                        <div class="deanbanzhu y"><?php if($moderatedby) { ?>版主: <span class="xi2"><?php echo $moderatedby;?></span><?php } ?></div>
                        <!--新帖-->
          	...
          	<a class="deanfatie" href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial'"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发表新帖</a>
                ...
                <div class="deanjscenter">
                    ...
                    <?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
                    	<div class="deani"></div>
                        <div id="forum_rules_<?php echo $_G['fid'];?>" class="deanbkms" style="<?php echo $collapse['forum_rules'];?>;">
...
<?php if(!IS_ROBOT) { ?>
<div class="y">
<?php if($post['invisible'] == 0) { ?><a href="forum.php?mod=viewthread&amp;action=printable&amp;tid=<?php echo $_G['tid'];?>" title="打印" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/printer.png" alt="打印" class="vm" /></a>
<?php } ?>
<a href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="上一主题"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/thread-prev.png" alt="上一主题" class="vm" /></a>
<a href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="下一主题"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/thread-next.png" alt="下一主题" class="vm" /></a>
</div>
...
<td class="pls" rowspan="2"><?php if($post['first']) { ?>
...
<td class="plc"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
    <i class="arr"></i>
<div class="pi <?php if($post['first']) { ?>tpi<?php } ?>"<?php if($close_leftinfo || (!$post['first'] && !$post['anonymous'] && $postshowavatars && $showavatars)) { ?> style="height:50px"<?php } ?>>
...
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2 z inside_avt" style="padding-right:10px; float:left;"><?php echo avatar($post['authorid'], 'big'); ?></a><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?>                <div class="gn_mods">
<?php if($_self ) { ?>
...
<?php } ?>
                    ...
                    <div class="gn_yds">
                    	<?php if($post['first']) { ?>
                        <span class="ico_see"><?php echo $_G['forum_thread']['views'];?></span>
                       	<span class="ico_reply"><?php echo $_G['forum_thread']['allreplies'];?></span>
                        <?php } ?>
                    </div>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/favourite.png" alt="收藏" /><div class="deanicon_bottom"><span class="deansc">收藏</span><span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></div></a>
...
<a class="followp" style="display:none;" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><i><img src="<?php echo IMGDIR;?>/rt.png" alt="转播" />转播<?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></i></a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/share.png" alt="分享" /><div class="deanicon_bottom"><span class="deansc">分享<?php if($_G['forum_thread']['sharetimes']) { ?></span><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></div></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" style="display:none;" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><i><img src="<?php echo IMGDIR;?>/collection.png" alt="分享" />淘帖<span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> style="display:none"<?php } ?>><?php echo $post['releatcollectionnum'];?></span></i></a>
<?php } if(($_G['group']['allowrecommend'] || !$_G['uid']) && $_G['setting']['recommendthread']['status']) { if(!empty($_G['setting']['recommendthread']['addtext'])) { ?>
<a id="recommend_add" href="forum.php?mod=misc&amp;action=recommend&amp;do=add&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_add').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['addtext'];?>'" title="顶一下"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/check.png" alt="<?php echo $_G['setting']['recommendthread']['addtext'];?>" /><div class="deanicon_bottom"><span class="deansc"><?php echo $_G['setting']['recommendthread']['addtext'];?></span><span id="recommendv_add"<?php if(!$_G['forum_thread']['recommend_add']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_add'];?></span></div></a>
<?php } if(!empty($_G['setting']['recommendthread']['subtracttext'])) { ?>
<a id="recommend_subtract" href="forum.php?mod=misc&amp;action=recommend&amp;do=subtract&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(-<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_subtract').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['subtracttext'];?>'" title="踩一下"><img src="<?php echo $_G['style']['styleimgdir'];?>/viewthread/close.png" alt="<?php echo $_G['setting']['recommendthread']['subtracttext'];?>" /><div class="deanicon_bottom"><span class="deansc"><?php echo $_G['setting']['recommendthread']['subtracttext'];?></span><span id="recommendv_subtract"<?php if(!$_G['forum_thread']['recommend_sub']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_sub'];?></span></div></a>
<?php } } ?>
        ...
        <!--推荐阅读-->
            <div class="deanlt_box" style=" background:none;">
                ...
                <div class="deankcbiox">
                    <ul>
                    	<!--[diy=deankcbiox]--><div id="deankcbiox" class="area"><div id="framee25u25" class="frame move-span cl frame-1"><div id="framee25u25_left" class="column frame-1-c"><div id="framee25u25_left_temp" class="move-span temp"></div><?php block_display('35');?></div></div></div><!--[/diy]-->
            ...
            <div class="deanlt_box">
                ...
                <div class="deancnxh">
                	<ul>
                    	<!--[diy=deancnxh]--><div id="deancnxh" class="area"><div id="frameXFdtc6" class="frame move-span cl frame-1"><div id="frameXFdtc6_left" class="column frame-1-c"><div id="frameXFdtc6_left_temp" class="move-span temp"></div><?php block_display('33');?></div></div></div><!--[/diy]-->
            ...
            <div class="deanlt_box">
                ...
                <div class="deanads">
                	<!--[diy=deanads]--><div id="deanads" class="area"><div id="frameVryRPm" class="frame move-span cl frame-1"><div id="frameVryRPm_left" class="column frame-1-c"><div id="frameVryRPm_left_temp" class="move-span temp"></div><?php block_display('34');?></div></div></div><!--[/diy]-->
