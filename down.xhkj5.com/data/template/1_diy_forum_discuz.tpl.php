...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frame5olOQH" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frame5olOQH_left" class="column frame-1-c"><div id="frame5olOQH_left_temp" class="move-span temp"></div><?php block_display('3');?></div></div></div><!--[/diy]-->
</div>
<?php } ?>
