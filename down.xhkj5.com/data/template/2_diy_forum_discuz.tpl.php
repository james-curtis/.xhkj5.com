...
block_get('6,7,8,9,36,37,5,4');?><?php include template('common/header'); ?>    <div class="w1180">
...
<div class="z"><?php if(!empty($_G['setting']['pluginhooks']['index_status_extra'])) echo $_G['setting']['pluginhooks']['index_status_extra'];?></div>
        ...
        <?php if(empty($gid)) { ?>
            ...
            <style id="diy_style" type="text/css">#portal_block_37 { border:#330033 3px !important;}</style>
        ...
        <div class="deannge">
        	...
        	<div class="deanltflash">
            	<!--[diy=deanltflash]--><div id="deanltflash" class="area"><div id="framePNGinR" class="frame move-span cl frame-1"><div id="framePNGinR_left" class="column frame-1-c"><div id="framePNGinR_left_temp" class="move-span temp"></div><?php block_display('6');?></div></div></div><!--[/diy]-->
                	...
                	<dl>
                    	<dd style="display:block;">
                        	<div class="deannr_box">
                            	<ul>
                                	<!--[diy=deannr_box]--><div id="deannr_box" class="area"><div id="framew83Zi2" class="frame move-span cl frame-1"><div id="framew83Zi2_left" class="column frame-1-c"><div id="framew83Zi2_left_temp" class="move-span temp"></div><?php block_display('7');?></div></div></div><!--[/diy]-->
                        ...
                        <dd>
                        	<div class="deannr_box">
                            	<ul>
                                	<!--[diy=deannr_box1]--><div id="deannr_box1" class="area"><div id="framekYRr7t" class="frame move-span cl frame-1"><div id="framekYRr7t_left" class="column frame-1-c"><div id="framekYRr7t_left_temp" class="move-span temp"></div><?php block_display('8');?></div></div></div><!--[/diy]-->
                                </ul>
                            </div>
                        </dd>
                        <dd>
                        	<div class="deannr_box">
                            	<ul>
                                	<!--[diy=deannr_box2]--><div id="deannr_box2" class="area"><div id="framedjt8c9" class="frame move-span cl frame-1"><div id="framedjt8c9_left" class="column frame-1-c"><div id="framedjt8c9_left_temp" class="move-span temp"></div><?php block_display('9');?></div></div></div><!--[/diy]-->
                                </ul>
                            </div>
                        </dd>
                    </dl>
...
jQuery(".deanbottom_box dd").eq(a).show().siblings().hide();
        ...
        <div id="ct" class="wp cl<?php if($_G['setting']['forumallowside']) { ?> ct2<?php } ?>">
            <?php if(empty($gid)) { ?>
                <div id="chart" class="bm bw0 cl">
                    <p class="chart z">
                        <span class="deanjinri">今日<br /><?php echo $todayposts;?></span><span class="deanzuori">昨日<br /><?php echo $postdata['0'];?></span><span class="deantiezishu">帖子<br /><?php echo $posts;?></span><span class="deanshuzi">会员<br /><?php echo $_G['cache']['userstats']['totalmembers'];?></span></p>
                    <div class="y">
            ...
            <?php } ?>
            <!--[diy=diy_chart]--><div id="diy_chart" class="area"><div id="frame11s7YO" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frame11s7YO_left" class="column frame-1-c"><div id="frame11s7YO_left_temp" class="move-span temp"></div><?php block_display('36');?><?php block_display('37');?></div></div></div><!--[/diy]-->
        ...
        <div class="deanluntan_left">
            ...
            <div class="mn">
                ...
                <div class="fl bm">
                    ...
                    <?php $forumscount = count($collectiondata['follows']);?>                    <?php $forumcolumns = 4;?>        
                ...
                <?php if(is_array($catlist)) foreach($catlist as $key => $cat) { ?>                    <?php if(!empty($_G['setting']['pluginhooks']['index_catlist'][$cat[fid]])) echo $_G['setting']['pluginhooks']['index_catlist'][$cat[fid]];?>
                    ...
                    <?php $forumscount = count($collectiondata['data']);?>                    <?php $forumcolumns = 4;?>        
                    <?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?>        
                    <div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl">
                        <div class="bm_h cl">
                            <span class="o">
        ...
        <div class="deanluntan_right">
            ...
            <div class="deanlt_box">
                ...
                <div class="deantjyd">
                	<ul>
                    	<!--[diy=deantjyd]--><div id="deantjyd" class="area"><div id="frameX55ZbZ" class="frame move-span cl frame-1"><div id="frameX55ZbZ_left" class="column frame-1-c"><div id="frameX55ZbZ_left_temp" class="move-span temp"></div><?php block_display('5');?></div></div></div><!--[/diy]-->
            ...
            <div class="deanlt_box">
                ...
                <div class="deancnxh">
                    	<!--[diy=deancnxh22]--><div id="deancnxh22" class="area"><div id="framexppPnm" class="frame move-span cl frame-1"><div id="framexppPnm_left" class="column frame-1-c"><div id="framexppPnm_left_temp" class="move-span temp"></div><?php block_display('4');?></div></div></div><!--[/diy]-->
                 </div>  
                </div>
            </div>
        </div>
