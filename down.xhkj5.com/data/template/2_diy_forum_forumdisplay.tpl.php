...
0
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/ymg6.com_1490552828/forum/forumdisplay_list.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/ymg6.com_1490552828//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1521213721, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/ymg6.com_1490552828/', 'forum/forumdisplay')
;
block_get('31,30,32');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="frameus4SlM" class="frame move-span cl frame-1"><div id="frameus4SlM_left" class="column frame-1-c"><div id="frameus4SlM_left_temp" class="move-span temp"></div><?php block_display('31');?></div></div><div id="frameJIQ42m" class="frame move-span cl frame-1"><div id="frameJIQ42m_left" class="column frame-1-c"><div id="frameJIQ42m_left_temp" class="move-span temp"></div><?php block_display('30');?></div></div><div id="frameM9ccIT" class="frame move-span cl frame-1"><div id="frameM9ccIT_left" class="column frame-1-c"><div id="frameM9ccIT_left_temp" class="move-span temp"></div><?php block_display('32');?></div></div></div><!--[/diy]-->
...
<!--版块介绍-->
            <div class="deanbkjs">
            	<div class="deanjstop">
                	<div class="deanjstopl"><?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" /><?php } ?></div>
...
<div class="deanancmtlist">

<?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { } ?>
<div class="deanannouncement">公告: </div>
                            <div class="deanamtcontent">
...
<div class="deananmtauthor"><a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>" c="1"><?php echo $announcement['author'];?></a></div>
<div class="deananmtdate">	<em><?php echo $announcement['starttime'];?></em></div>
                            <div class="clear"></div>
</div>
...
<?php echo $thread['lastpost'];?>
                                        ...
                                        <i class="y">
                                            <span class="dean_view"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></span>
                                            <span class="dean_reply"><?php echo $thread['allreplies'];?></span>
                                            <span class="dean_like"><?php echo $thread['heats'];?></span>
                                        </i>
...
<?php } ?>
                                        ...
                                        <div class="deanforum_list_intro" style="display:none;"><?php echo $thread['preview'];?></div>
</th>
<?php if(CURMODULE == 'guide') { ?>
...
<ul id="waterfall" class="ml waterfall cl deanwaterfall"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if($_G['hiddenexists'] && $thread['hidden']) { continue;?><?php } if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?><li style="width:<?php echo $waterfallwidth;?>px">
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
...
<?php } ?>
<div class="waterfallpics">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>" <?php if($thread['isgroup'] == 1 || $thread['forumstick'] || CURMODULE == 'guide') { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>">
<?php if($thread['cover']) { ?>
<img src="<?php echo $thread['coverpath'];?>" alt="<?php echo $thread['subject'];?>" />
                                            <div class="deanwaterfallcover" style="display:none;"><h1><?php echo $thread['preview'];?></h1></div>
...
<h5 class="deanwaterfalltitle">
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?>
<div class="deanfenleilabel"><?php if($thread['typehtml']) { ?><?php echo $thread['typehtml'];?> <?php echo $thread['sorthtml'];?><?php } ?></div>
                                    <a class="deanwft" href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>"><?php echo $thread['subject'];?></a>
                                    <div class="clear"></div>
</h5>
                                <div class="deanwaterfallinfo">
                                        
                                    <em class="deanviews"><?php echo $thread['views'];?></em>
                                    <em class="deancomments"><?php echo $thread['replies'];?></em>
                                    <em class="deanrecommends"><?php echo $thread['recommends'];?></em>
                                </div>
<div class="waterfallbottom">
                                	<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?>
<?php if($thread['authorid'] && $thread['author']) { ?>
<a class="deanlistavator" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>">
                                        <?php if($thread['authorid'] && $thread['author']) { ?>
                                            <?php echo avatar($thread[authorid],middle);?>                                        <?php } ?>
                                        <span><?php echo $thread['author'];?></span>
                                        <div class="clear"></div>
                                        </a>
                                        <?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } } else { ?>
<?php echo $_G['setting']['anonymoustext'];?>
<?php } ?>
                                    <div class="deanftsj"><?php echo $thread['dateline'];?></div>
