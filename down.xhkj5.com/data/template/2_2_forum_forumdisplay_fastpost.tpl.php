...
0
|| checktplrefresh('./template/ymg6.com_1490552828/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1521213598, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/ymg6.com_1490552828', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ymg6.com_1490552828/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1521213598, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/ymg6.com_1490552828', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ymg6.com_1490552828/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1521213598, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/ymg6.com_1490552828', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ymg6.com_1490552828/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1521213598, '2', './data/template/2_2_forum_forumdisplay_fastpost.tpl.php', './template/ymg6.com_1490552828', 'forum/forumdisplay_fastpost')
;?>
...
</span><?php $seditor = array('fastpost', array('at', 'bold', 'color', 'img', 'link', 'quote', 'code', 'smilies'), !$allowfastpost ? 1 : 0, $allowpostattach && $allowfastpost ? '<span id="spanButtonPlaceholder">'.lang('template', 'upload').'</span>' : '');?><?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_fastpost_ctrl_extra'])) echo $_G['setting']['pluginhooks']['forumdisplay_fastpost_ctrl_extra'];?><script src="<?php echo $_G['setting']['jspath'];?>seditor.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<div class="fpd">
