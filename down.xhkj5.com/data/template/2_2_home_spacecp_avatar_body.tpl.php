...
<script src="static/js/mobile/jquery.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script type="text/javascript">
jQuery.noConflict();
var data = "<?php echo implode(",", $uc_avatarflash);; ?>".split(',');
</script>

<link rel="stylesheet" href="static/avatar/avatar.css?<?php echo VERHASH;?>" />							
<script src="static/avatar/jquery-ui.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script src="static/avatar/avatar.js?<?php echo VERHASH;?>" type="text/javascript"></script>
