...
.postalbum_h_back { position:absolute; left:10px; top:0px; height:44px; width:30%; z-index:90; color:white; }
.postalbum_h_picnum { position:absolute; right:10px; top:0px; height:44px; width:60%; z-index:90; color:white;text-align:right; }
...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;page=<?php echo $_G['page'];?>" class="postalbum_h_back">返回</a>
