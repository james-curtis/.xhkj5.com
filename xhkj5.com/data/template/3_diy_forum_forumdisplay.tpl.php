...
<a id="forumarchive" href="javascript:;" class="fa_achv" onmouseover="showMenu(this.id)"><?php if($_GET['archiveid']) { ?><?php echo $forumarchive[$_GET['archiveid']]['displayname'];?><?php } else { ?>存档<?php } ?></a>
<?php } ?>
...
<div class="comiis_infotxt">本版域名: <a href="http://<?php echo $_G['forum']['domain'];?>.<?php echo $_G['setting']['domain']['root']['forum'];?>" id="group_link">http://<?php echo $_G['forum']['domain'];?>.<?php echo $_G['setting']['domain']['root']['forum'];?></a></div>
<?php } ?>						
<?php } ?>
<div class="comiis_infotxt"><?php if(!$subforumonly) { ?>今日: <?php echo $_G['forum']['todayposts'];?><?php if($_G['forum']['todayposts']) { if($_G['forum']['todayposts'] < $_G['forum']['yesterdayposts']) { ?><b class="ico_fall">&nbsp;</b><?php } else { ?><b class="ico_increase">&nbsp;</b><?php } } ?><span class="pipe">|</span>主题: <?php echo $_G['forum']['threads'];?><?php if($_G['forum']['rank']) { ?><span class="pipe">|</span>排名: <span title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></span><?php if($_G['forum']['rank'] <= $_G['forum']['oldrank']) { ?><b class="ico_increase">&nbsp;</b><?php } else { ?><b class="ico_fall">&nbsp;</b><?php } } ?></span><?php } ?></div>
<div class="comiis_infotxt">版主: <?php if($moderatedby) { ?><?php echo $moderatedby;?><?php } else { ?>暂无<?php } ?></div>
...
<?php if(!empty($_G['forum']['picstyle'])) { ?><a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked y"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk y"<?php } ?> title="图片模式浏览帖子">图片模式</a><?php } ?>
<div class="z">
...
<span class="showmenu"><?php if($_GET['rewardtype'] == '') { ?>全部悬赏<?php } elseif($_GET['rewardtype'] == '1') { ?>进行中<?php } elseif($_GET['rewardtype'] == '2') { ?>已解决<?php } ?></span>
</a>
<?php } ?>
...
<span class="showmenu"><?php if($_GET['dateline'] == 86400) { ?>一天<?php } elseif($_GET['dateline'] == 172800) { ?>两天<?php } elseif($_GET['dateline'] == 604800) { ?>一周<?php } elseif($_GET['dateline'] == 2592000) { ?>一个月<?php } elseif($_GET['dateline'] == 7948800) { ?>三个月<?php } else { ?>全部时间<?php } ?></span>
</a>
...
<span class="showmenu"><?php if($_GET['orderby'] == 'dateline') { ?>发帖时间<?php } elseif($_GET['orderby'] == 'replies') { ?>回复/查看<?php } elseif($_GET['orderby'] == 'views') { ?>查看<?php } elseif($_GET['orderby'] == 'lastpost') { ?>最后发表<?php } elseif($_GET['orderby'] == 'heats') { ?>热门<?php } else { ?>默认排序<?php } ?></span>
</a>
...
<h2 class="cl">
<span class="comiis_icn"><img src="<?php echo IMGDIR;?>/ann_icon.gif" alt="公告" /></span>
<span class="comiis_common"><strong class="xst">公告: <?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?></strong></span>
</h2>
<p>
<em class="km_user"><a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>" c="1"><?php echo $announcement['author'];?></a></em>
<em>发表于: <?php echo $announcement['starttime'];?></em>
</p>
</div>
</td></tr>
</tbody>
...
<h3><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>版块主题<?php } ?></h3>
</div>
</td></tr>
</tbody>
...
<a href="javascript:void(0);" onclick="hideStickThread('<?php echo $thread['tid'];?>')" class="showhide y" title="隐藏置顶帖">隐藏置顶帖</a>
...
<?php if($_G['setting']['threadhidethreshold'] && $thread['hidden'] >= $_G['setting']['threadhidethreshold']) { ?><span class="comiis_hs">隐藏</span>&nbsp;<?php } if($thread['icon'] >= 0) { ?>
...
<span id="rushtimer_<?php echo $thread['tid'];?>" class="comiis_tc"> 【还有 <span id="rushtimer_body_<?php echo $thread['tid'];?>"></span> <script language="javascript">settimer(<?php echo $rushinfo[$thread['tid']]['timer'];?>, 'rushtimer_body_<?php echo $thread['tid'];?>');</script><?php if($rushinfo[$thread['tid']]['timertype'] == 'start') { ?> 开始 <?php } else { ?> 结束 <?php } ?> 】</span>
<?php } } if($stemplate && $sortid) { ?><?php echo $stemplate[$sortid][$thread['tid']];?><?php } if($thread['readperm']) { ?> - <span class="comiis_tc">[阅读权限 <b><?php echo $thread['readperm'];?></b>]</span><?php } if($thread['price'] > 0) { if($thread['special'] == '3') { ?>
- <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=1" title="只看进行中的"><span class="comiis_tc">[悬赏 <b><?php echo $thread['price'];?></b> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['2']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['2']]['title'];?>]</span></a>
<?php } else { ?>
- <span class="comiis_tc">[售价 <b><?php echo $thread['price'];?></b> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?>]</span>
<?php } } elseif($thread['special'] == '3' && $thread['price'] < 0) { ?>
- <span class="comiis_tc"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=specialtype&amp;specialtype=reward<?php echo $forumdisplayadd['specialtype'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>&amp;rewardtype=2" title="只看已解决的">[已解决]</a></span>
<?php } if($thread['attachment'] == 2) { ?>
<img src="<?php echo IMGDIR;?>/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
...
- <span class="comiis_tc">[回帖奖励 <strong> <?php echo $thread['replycredit'];?></strong> ]</span>
<?php } ?>
...
<em><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span> 发表<?php if($thread['typehtml'] || $thread['sorthtml']) { ?>在<?php } ?></em>
...
<a href="javascript:;" rel="<?php echo $multipage_more;?>" curpage="<?php echo $page;?>" id="autopbn" totalpage="<?php echo $maxpage;?>" picstyle="<?php echo $_G['forum']['picstyle'];?>" forumdefstyle="<?php echo $_G['cookie']['forumdefstyle'];?>"><i></i>查看下一页</a>
<script src="<?php echo $_G['setting']['jspath'];?>autoloadpage.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } else { ?>
<div id="pgbtn" class="pgbtn"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=<?php echo $filter;?>&amp;orderby=<?php echo $_GET['orderby'];?><?php echo $forumdisplayadd['page'];?>&amp;<?php echo $multipage_archive;?>&amp;page=<?php echo $nextpage;?>" hidefocus="true">加载下一页</a></div>
<?php } } ?>
...
<a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖" class="kmfbzt"></a>
...
<?php if($_G['forum']['rules']) { ?><?php echo $_G['forum']['rules'];?><?php } else { ?>暂无公告，请到后台版块规则处添加<?php } ?>
</div>
</div>
<?php } ?>
