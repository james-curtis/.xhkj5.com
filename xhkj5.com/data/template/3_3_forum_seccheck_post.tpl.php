...
0
|| checktplrefresh('./template/default/forum/seccheck_post.htm', './template/default/common/seccheck.htm', 1524588418, '3', './data/template/3_3_forum_seccheck_post.tpl.php', './template/comiis_nby', 'forum/seccheck_post')
;?><?php
$sectpl = <<<EOF
