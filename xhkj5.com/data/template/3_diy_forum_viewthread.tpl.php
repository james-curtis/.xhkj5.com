...
<a href="javascript:;" id="comiis_guanli" onmouseover="showMenu({'ctrlid':'comiis_guanli'});"><img src="<?php echo IMGDIR;?>/pn_guanli.png" alt="帖子管理" /></a>
<?php } ?>
...
<?php if(!$close_leftinfo) { ?>
<a onclick="setcookie('close_leftinfo', 1);location.reload();" title="收起左侧" href="javascript:;"><img src="<?php echo IMGDIR;?>/control_l.png" alt="收起左侧" class="vm" /></a>
<?php } else { ?>
<a onclick="setcookie('close_leftinfo', 2);location.reload();" title="开启左侧" href="javascript:;"><img src="<?php echo IMGDIR;?>/control_r.png" alt="开启左侧" class="vm" /></a>
<?php } ?>
</div>
<?php } if($close_leftinfo && $modmenu['thread']) { ?>
<div style="position:absolute;left:8px;top:8px;">		
<a href="javascript:;" id="comiis_guanli" onmouseover="showMenu({'ctrlid':'comiis_guanli'});"><img src="<?php echo IMGDIR;?>/comiis_nbygl.gif" alt="帖子管理" /></a>		
</div>
<?php } ?>
...
<h2 class="z">
<?php if($thread['digest'] > 0 && $filter != 'digest') { ?><a herf="javascript:;" title="精华" class="km1 kmjh">精</a><?php } if(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?><a herf="javascript:;" title="置顶" class="km1 kmzd">顶</a><?php } ?>	
...
<a href="forum.php?mod=misc&amp;action=pubsave&amp;tid=<?php echo $_G['tid'];?>" class="psave">发表</a>
<?php } } if($_G['setting']['threadhidethreshold'] && $_G['forum_thread']['hidden'] >= $_G['setting']['threadhidethreshold']) { ?>						
<?php if($_G['forum_thread']['authorid'] == $_G['uid']) { ?><a href="forum.php?mod=misc&amp;action=hiderecover&amp;tid=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" class="psave" id="hiderecover" title="点击恢复主题隐藏状态" onclick="showWindow(this.id, this.href, 'get', 0);">隐藏</a><?php } else { ?>(隐藏)<?php } ?>
&nbsp;
...
<a href="forum.php?mod=misc&amp;action=viewwarning&amp;tid=<?php echo $_G['tid'];?>&amp;uid=<?php echo $post['authorid'];?>" title="受到警告" onclick="showWindow('viewwarning', this.href)"><img src="<?php echo IMGDIR;?>/warning.gif" alt="受到警告" /></a>
<?php } ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')" <?php if($fromuid) { ?>title="您的朋友访问此链接后，您将获得相应的积分奖励"<?php } ?> class="kmcopy">[复制链接]</a>
</span>
...
<em class="views" title="查看"><?php echo $_G['forum_thread']['views'];?></em>
<em class="replies" title="回复"><?php echo $_G['forum_thread']['replies'];?></em>			
</span>
<span class="xg1">
...
<span class="z">楼主: <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>"><?php echo $_G['forum_thread']['author'];?></a>&nbsp;-&nbsp;</span>
<?php } else { ?>
楼主:
...
<?php if(!IS_ROBOT) { ?>
<span class="y comiis_hfs"><strong><?php echo $_G['forum_thread']['allreplies'];?></strong><br>回复</span>
<span class="y comiis_cks"><strong><?php echo $_G['forum_thread']['views'];?></strong><br>查看</span>
...
<li><a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="收听TA" onclick="showWindow('followmod', this.href, 'get', 0);" class="kmstt">收听TA</a></li>
<?php } ?>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="kmfxx">发消息</a></li>
</ul>
<?php } } ?>
...
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $post['authorid'];?>" rel="nofollow"><?php if($close_leftinfo && $post['first']) { ?>只看楼主<?php } else { ?>只看该作者<?php } ?></a>
<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow"><?php if($close_leftinfo && $post['first']) { ?>查看全部<?php } else { ?>显示全部楼层<?php } ?></a>
...
<span class="pipe">|</span>&nbsp;<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;from=album" target="_blank">只看大图</a>
<?php } if(!$close_leftinfo) { ?><span class="none"><img src="<?php echo IMGDIR;?>/arw_r.gif" class="vm" alt="回帖奖励" /></span>
...
<span class="pipe<?php if(!$close_leftinfo) { ?> show<?php } ?>">|</span>&nbsp;<a href="javascript:;" onclick="readmode($('thread_subject').innerHTML, <?php echo $post['pid'];?>);"<?php if(!$close_leftinfo) { ?> class="show"<?php } ?>>阅读模式</a>
<?php } ?>
...
<table class="ratl">
<tr>
<th class="xw1" width="180"><a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分">已有<?php echo count($postlist[$post['pid']]['totalrate']);; ?>人评分</a></th><?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { if($score > 0) { ?>
...
<p class="ratc xg1">
<a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分" class="xi1 y">查看全部评分</a>
...
<h2 class="cl">
<?php if(!IS_ROBOT && !$_G['forum_thread']['archiveid'] && !$rushreply) { ?><div class="y comiis_hfpx"><a onmouseover="showMenu(this.id)" class="showmenu" href="javascript:;" id="comiis_hfpx"><?php if($ordertype != 1) { ?>正序浏览<?php } else { ?>倒序浏览<?php } ?></a></div><?php } if(!IS_ROBOT && !$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { ?>
<div id="fj" class="y">
...
<?php } ?>
<span class="z"><?php echo $_G['forum_thread']['allreplies'];?> 个评论</span>
</h2>
</div>
<?php if(!IS_ROBOT && !$_G['forum_thread']['archiveid'] && !$rushreply && $_G['forum_thread']['allreplies']!=0) { ?>
        <div style="display:none" class="p_pop" id="comiis_hfpx_menu">
          <ul>
<?php if($ordertype != 1) { ?>
            <li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2#comiis_allreplies">正序浏览</a></li>
            <li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1#comiis_allreplies">倒序浏览</a></li>
            <?php } else { ?>
            <li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1#comiis_allreplies">倒序浏览</a></li>
            <li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2#comiis_allreplies">正序浏览</a></li>
            <?php } ?>
...
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="comiis_pgbtn"><i></i>查看下一页</a>
<?php } ?>
</div>
<?php } else { ?>
<div class="pgbtn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="bm_h">下一页 &raquo;</a></div>
<?php } if($close_leftinfo) { ?>
<div class="comiis_pgs cl">	
<span class="pgb"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span><?php echo $multipage;?>
</div>
<?php } else { ?>
...
<?php if(!$close_leftinfo) { ?><div class="comiis_divtis">提醒：为防止数据丢失，下面边栏数据DIY的时候会出现，不会影响正常使用，谢谢!</div><?php } ?>
<div style="height:158px;overflow:hidden;">	
<div class="comiis_irbox comiis_irftbtn cl" id="comiis_irftbtn">
<a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖" class="kmfbzt" title="发表主题"></a>
...
<ul>
<li class="a1"><?php if($_G['uid']) { ?><a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复</a><?php } else { ?><span>回复</span><?php } ?></LI>
<li class="a2"><?php if(helper_access::check_module('follow') && $_G['uid']) { ?><a href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);">转播</a><?php } else { ?><span>转播</span><?php } ?></li>
<li class="a3"><?php if($_G['group']['raterange'] && $_G['uid']) { ?><a href="javascript:;" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;">评分</a><?php } else { ?><span>评分</span><?php } ?></li>
<li class="a4"><?php if(helper_access::check_module('share') && $_G['uid']) { ?><a href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);">分享</a><?php } else { ?><span class="a4">分享</span><?php } ?></li>
</ul>
</div>
</div>	
</div>
...
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" title="访问我的空间"><?php echo avatar($_G[forum_thread][authorid],middle);?></a>
</div>
<div class="kmuser">
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" title="访问我的空间" c="1"><?php echo $_G['forum_thread']['author'];?></a><?php $comiis_threadnum = '';?><?php if(is_array($postlist)) foreach($postlist as $post) { if($post['first']) { if(is_array($post['verifyicon'])) foreach($post['verifyicon'] as $vid) { ?><a href="home.php?mod=spacecp&amp;ac=profile&amp;op=verify&amp;vid=<?php echo $vid;?>" target="_blank"><?php if($_G['setting']['verify'][$vid]['icon']) { ?><img src="<?php echo $_G['setting']['verify'][$vid]['icon'];?>" class="vm" alt="<?php echo $_G['setting']['verify'][$vid]['title'];?>" title="<?php echo $_G['setting']['verify'][$vid]['title'];?>" /><?php } else { ?><?php echo $_G['setting']['verify'][$vid]['title'];?><?php } ?></a>
