...
0
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/default/common/header_common.htm', 1524236863, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_nby', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/comiis_user.htm', 1524236863, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_nby', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/comiis_navss.htm', 1524236863, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_nby', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/header_qmenu.htm', 1524236863, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_nby', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/default/common/pubsearchform.htm', 1524236863, '3', './data/template/3_3_common_header_forum_forumdisplay.tpl.php', './template/comiis_nby', 'common/header_forum_forumdisplay')
;?>
