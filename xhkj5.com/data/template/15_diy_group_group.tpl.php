...
0
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_index.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_list.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_memberlist.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_create.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_invite.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_manage.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_right.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seccheck.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1530224920, 'diy', './data/template/15_diy_group_group.tpl.php', './template/xhkj5.com_iuni', 'group/group')
...
<?php if(!$_G['forum']['allowspecialonly']) { ?><li><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" onclick="showWindow('newthread', this.href);doane(event)">发新话题</a></li><?php } if($_G['group']['allowpostpoll']) { ?><li class="poll"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=1">发投票</a></li><?php } if($_G['group']['allowpostreward']) { ?><li class="reward"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=3">发悬赏</a></li><?php } if($_G['group']['allowpostdebate']) { ?><li class="debate"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=5">发辩论</a></li><?php } if($_G['group']['allowpostactivity']) { ?><li class="activity"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=4">发布活动</a></li><?php } if($_G['group']['allowposttrade']) { ?><li class="trade"><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>&amp;special=2">发布商品</a></li><?php } if($_G['setting']['threadplugins']) { if(is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { if(array_key_exists($tpid, $_G['setting']['threadplugins']) && @in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
