<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('urlpush');
0
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/comiis_nby/common/header.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/comiis_nby/common/footer.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/default/common/header_common.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/comiis_nby/common/comiis_user.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/comiis_nby/common/comiis_navss.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/comiis_nby/common/header_qmenu.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
|| checktplrefresh('./source/plugin/urlpush/template/urlpush.htm', './template/default/common/pubsearchform.htm', 1524245990, 'urlpush', './data/template/3_urlpush_urlpush.tpl.php', './source/plugin/urlpush/template', 'urlpush')
;?>
...
.urlpush_tb { width:100%;}
.urlpush_tb td { padding:8px 5px;}
.urlpush_tb td input {width:300px;}
.urlpush_tb td a { display:block; float:left; line-height:26px; padding:0 10px;}
.urlpush_tb td a.a { color:#00C;font-weight:700}
</style>
<h3 class="flb">
    <em id="return_upload">链接提交</em>
    <span><a href="javascript:;" class="flbc" onclick="hideWindow('<?php echo $_GET['handlekey'];?>', 0)" title="关闭">关闭</a></span>
</h3>
<form id="editform" name="editform" method="post" autocomplete="off" onsubmit="ajaxpost(this.id,'return_editmain');;return false;" action="plugin.php?id=urlpush">
    <input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" >
    <input type="hidden" name="editsubmit" value="true" >
    <input type="hidden" name="handlekey" value="editmain" >
    <input type="hidden" name="tid" value="<?php echo $thread['tid'];?>" >
    <div class="c">
    	<table class="urlpush_tb">
        	<tbody>
            	<tr>
                	<td>提交地址</td>
                    <td class="tpclg"><input type="text" name="urlpush_url" id="urlpush_url" class="px" value="<?php echo $_G['siteurl'];?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>"></td>
                </tr>
                <tr>
                	<td></td>
                    <td>
                    	<a id="urlpush_1" href="#" onClick="urlpush_url(this.id,'this');return false;">当前地址</a>
                    	<a class="a" id="urlpush_2" href="#" onClick="urlpush_url(this.id);return false;">默认地址</a>
                    </td>
                </tr>
            </tbody>
        </table>
    </div>
    <p class="o pns"><button type="submit" name="editsubmit_btn" id="editsubmit_btn" class="pn pnc" value="true"><span>确定提交</span></button></p>
</form>
<span id="return_editmain" style="display:none"></span>
<script>
function urlpush_url(id,type){
if(type == 'this'){
var url = window.location;
}else{
var url = "<?php echo $_G['siteurl'];?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>";
}
$('urlpush_url').value = url;
$('urlpush_1').className = '';
$('urlpush_2').className = '';
$(id).className = 'a';
}
