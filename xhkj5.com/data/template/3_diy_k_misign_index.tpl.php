<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('k_misign_index');
0
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/comiis_nby/common/header.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/comiis_nby/common/footer.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/default/common/header_common.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/comiis_nby/common/comiis_user.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/comiis_nby/common/comiis_navss.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/comiis_nby/common/header_qmenu.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
|| checktplrefresh('source/plugin/k_misign/template/default/k_misign_index.htm', './template/default/common/pubsearchform.htm', 1524237123, 'diy', './data/template/3_diy_k_misign_index.tpl.php', 'source/plugin/k_misign/template/default', 'k_misign_index')
;?>
...
<div id="magic_bq_menu" class="tip tip_4" style="display:none;"><div class="tip_horn"></div><div class="tip_c"><?php echo $bqshowtip;?></div></div>
...
<div class="y">
    ...
    <span class="xg1">今日签到之星：<?php if($todaystar['username']) { ?><?php echo $todaystar['username'];?><?php } else { ?>暂无内容<?php } ?></span>

        <span class="pipe">|</span>

        <span class="xg1">历史最高人数：<?php if($stats['highestq'] > $stats['todayq']) { ?><?php echo $stats['highestq'];?><?php } else { ?><?php echo $stats['todayq'];?><?php } ?>人</span>

        <span class="pipe">|</span>

        <span class="xg1"><a href="<?php echo $setting['pluginurl'];?>misc&operation=rewardrule">奖励规则</a></span>
...
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em>
        ...
        <a href="<?php echo $setting['pluginurl'];?>sign"><?php echo $setting['title'];?></a>
...
<div class="wp cl">
    ...
    <div class="lineB cl">
        ...
        <div class="qdleft">
            ...
            <a id="JD_sign" <?php if($_G['uid']) { ?>href="<?php echo $setting['pluginurl'];?>sign&operation=qiandao&formhash=<?php echo FORMHASH;?>&from=insign" onclick="ajaxget(this.href, this.id, '', '', '', 'window.location.reload();');return false;"<?php } else { ?> href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href);return false;"<?php } ?> class="btn J_chkitot"></a>

            <?php } ?>

            <div class="paiming cl">

                <input type="hidden" class="hidnum" id="qiandaobtnnum" value="<?php echo $qiandaodb['row'];?>">

                <div class="font">

                    <?php if($qiandaodb['time'] > $tdtime) { ?>您的签到排名：<?php echo $qiandaodb['row'];?><?php } else { ?>您今天还没有签到<?php } ?>

                </div>

                <div class="pics J_numpic cl J_animation" id="qdbn2"<?php if($qiandaodb['time'] < $tdtime) { ?> style="display:none;"<?php } ?>>

                <?php $qdbn2 = str_split($qiandaodb['row']);?>                <?php if(is_array($qdbn2)) foreach($qdbn2 as $value) { ?>                    <span class="<?php echo $numtostr[$value];?>"></span>
            ...
            <div class="content">
                ...
                <h3 class="mainCon">
                    ...
                    <div class="user">
                        ...
                        <a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" c="1"><?php echo avatar($_G['uid'], small);?></a>

                        <a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" c="1" class="author"><?php echo $_G['username'];?></a>

                    </div>

                    <?php if($extend['k_migeyan']) { ?>

                    <span class="jtitle">每日正能量：</span>

<div class="jingju J_xyline">

<span id="bigpower" class="xyart J_xyfont"><?php echo $k_migeyan['geyan']['subject'];?></span>
                ...
                <ul class="countqian cl">
                    ...
                    <li>
                        ...
                        <h4>连续签到<?php if($tobqday) { ?><a href="home.php?mod=magic&amp;mid=k_misign:k_misign_bq&amp;bid=<?php echo $bq['bid'];?>" id="magic_bq" onclick="showWindow(this.id, this.href, 'get', 0)" onmouseover="showMenu({'ctrlid':this.id, 'pos':'12!', 'menuid':'magic_bq_menu'});" class="xi1 notice">补签</a><?php } ?></h4>

                        <p>

                            <input type="hidden" class="hidnum" id="lxdays" value="<?php echo $qiandaodb['lasted'];?>">

                            <b class="pics J_numpic J_animation" style="height:23px;"><?php $qdbn3 = str_split($qiandaodb['lasted']);?><?php if(is_array($qdbn3)) foreach($qdbn3 as $value) { ?><span class="<?php echo $numtostr[$value];?>"></span>
...
<?php } ?>
                    ...
                    <li>
                        ...
                        <p class="lvgrade">
                            ...
                            <input type="hidden" class="hidnum" id="lxlevel" value="<?php echo $qiandaodb['level'];?>">

                            <b class="pics J_numpic J_animation" style="height:26px;"><?php $qdbn4 = str_split($qiandaodb['level']);?><?php if(is_array($qdbn4)) foreach($qdbn4 as $value) { ?><span class="<?php echo $numtostr[$value];?>"></span>
...
<?php } ?>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            <input type="hidden" class="hidnum" id="lxreward" value="<?php echo $qiandaodb['lastreward'];?>">

                            <b class="pics J_numpic J_animation" style="height:23px;"><?php $qdbn5 = str_split($qiandaodb['lastreward']);?><?php if(is_array($qdbn5)) foreach($qdbn5 as $value) { ?><span class="<?php echo $numtostr[$value];?>"></span>

<?php } ?>

                            </b>

                            <b><?php echo $_G['setting']['extcredits'][$setting['nrcredit']]['unit'];?></b>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            <input type="hidden" class="hidnum" id="lxtdays" value="<?php echo $qiandaodb['days'];?>">

                            <b class="pics J_numpic J_animation" style="height:23px;"><?php $qdbn6 = str_split($qiandaodb['days']);?><?php if(is_array($qdbn6)) foreach($qdbn6 as $value) { ?><span class="<?php echo $numtostr[$value];?>"></span>
...
<?php } ?>
                ...
                <div class="weather_p">
                    ...
                    <div class="con">
                        ...
                        <?php echo $stats['todayq'];?><span>人</span>
...
<div class="lineC_left cl" id="ranklist">
        ...
        <script>ajaxget('<?php echo $setting['pluginurl'];?>sign&operation=list','ranklist');</script>

<div class="lineC_right cl">

<h3 class="tit"><?php echo $setting['pushtitle'];?></h3>

            <?php if($pushmemberlists) { ?>

<ul class="photos cl">

            <?php if(is_array($pushmemberlists)) foreach($pushmemberlists as $value) { ?><li>

                        <img src="<?php echo $value['pic'];?>" class="head_img" />

                        <div class="info  J_info" id="J_info_1" style="bottom: -161px;">

                            <h3><?php echo $value['title'];?></h3>

                            <p class="con"><?php echo $value['message'];?></p>

                            <p class="link">访问详情<img src="./source/plugin/k_misign/static/default/come_11.jpg"></p>

                        </div>

                        <a target="_blank" href="<?php echo $value['url'];?>" class="J_intro mask"></a>
            ...
            <center><span class="xi1">暂无内容</span></center>
    ...
    <?php if($setting['prizestatus']) { ?>

<div class="lineD">

<h3 class="tit"><?php echo $setting['rewardtitle'];?></h3>

<div class="content cl">

<ul class="leftcon cl J_mifens" id="J_mifens">

            <?php if(is_array($prizememberlist)) foreach($prizememberlist as $key => $prizemember) { ?>            <?php $prizemember['avatar'] = str_replace('\/' ,'/', $prizemember['avatar'])?>               <li id="mifen<?php echo $key;?>">

                    <a href="home.php?mod=space&amp;uid=<?php echo $prizemember['uid'];?>" c="1" class="headimg"><img src="<?php echo $prizemember['avatar'];?>"></a>

                    <a href="home.php?mod=space&amp;uid=<?php echo $prizemember['uid'];?>" class="author"><?php echo $prizemember['username'];?></a><br>

                    <span class="thing">获得了<?php echo $prizemember['prizename'];?></span>
            ...
            <div class="rewardlist" id="demo" style=" overflow:hidden; height:180px;">

                <div id="demo1">

                    <ul class="arts J_linescroll">

                    <?php if(is_array($rewardmemberlists)) foreach($rewardmemberlists as $key => $rewardmember) { ?>                            <li><span class="user"><?php echo $rewardmember['username'];?></span><span>获得了&nbsp;<?php echo $rewardmember['lastreward'];?><?php echo $_G['setting']['extcredits'][$setting['nrcredit']]['unit'];?><?php echo $_G['setting']['extcredits'][$setting['nrcredit']]['title'];?></span></li>
...
var stim = 80; //鍋滅暀鏃堕棿鍊嶆暟 * speed

var stop = 0; //鍒濆鍖栧�硷紝涓嶇
...
var mifens = {"start":0,"end":9,"data":[<?php if(is_array($prizememberlist)) foreach($prizememberlist as $key => $prizemember) { ?>{"vip":1,"uid":"<?php echo $prizemember['uid'];?>","name":"<?php echo $prizemember['username'];?>","title":"<?php echo $prizemember['prizename'];?>","head":"<?php echo $prizemember['avatar'];?>","href":"home.php?mod=space&amp;uid=<?php echo $prizemember['uid'];?>"},
