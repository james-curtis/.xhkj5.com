...
0
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/comiis_nby/common/header.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/comiis_nby/common/footer.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/default/common/header_common.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/comiis_nby/common/comiis_user.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/comiis_nby/common/comiis_navss.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/comiis_nby/common/header_qmenu.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
|| checktplrefresh('./source/plugin/nimba_linkhelper/template/addlink.htm', './template/default/common/pubsearchform.htm', 1524838638, 'nimba_linkhelper', './data/template/3_nimba_linkhelper_addlink.tpl.php', './source/plugin/nimba_linkhelper/template', 'addlink')
;?>
...
<div class="z"><a href="./" class="nvhm"><?php echo $_G['setting']['bbname'];?></a><em>&rsaquo;</em><a href="./"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em><a href="plugin.php?id=nimba_linkhelper:addlink">!appname!</a> <em>&rsaquo;</em><?php echo $plugin_nav;?></div>
</div>
...
<div class="mn">
    	<div class="bm bw0">
            <div class="bm bw0">
<ul class="tb cl">
<li <?php if($_GET['mod']== 'apply' || empty($_GET['mod'])) { ?>class="a"<?php } ?>><a href="plugin.php?id=nimba_linkhelper:addlink&amp;mod=apply">!appntab_applyame!</a></li>
<?php if(!empty($_G['uid'])) { ?><li <?php if($_GET['mod']== 'log') { ?>class="a"<?php } ?>><a href="plugin.php?id=nimba_linkhelper:addlink&amp;mod=log">!tab_log!</a></li><?php } ?>
</ul>
<div class="datalist" style="margin:10px 0 0 0;">
<?php if($_GET['mod']== 'apply' || empty($_GET['mod'])) { ?>
<div style="border:1px dashed #f60; background-color:#FFC" class="notice">!l1!<br>!l3!<?php echo $vars['ailab_wz'];?><br>!l2!<?php echo $vars['ailab_url'];?></div>
...
<tr>
<td width="100" height="35" bgcolor="#F2F2F2" align="center"><span style="color:red;">*</span> !sitename!</td>
<td colspan="2">&nbsp;&nbsp;&nbsp;<input type="text" name="sitename" style="width:220px; height:22px; line-height22px;" /> <?php echo $site_name;?></td>
</tr>
<tr>
<td height="35" bgcolor="#F2F2F2" align="center"><span style="color:red;">*</span>!siteurl!</td>
...
<button type="submit" name="applysubmit" id="applysubmit" value="true" class="pn pnp" /><strong>!submit!</strong></button>
<button type="reset" name="sendreset" class="pn pnp" /><strong>!reset!</strong></button>
</div>
</form>
...
<td width="140">!log_title1!</td>
<td height="35">!log_title2!</td>
<td width="60">!log_title3!</td>
<td width="80">!log_title4!</td>
<td width="100">!log_title5!</td>
<td width="60">!log_title6!</td>
...
<td><span id="viewmsg_<?php echo $loglist['id'];?>" onmouseover="showMenu(this.id);"><a href="javascript:;" class="red">!viewintro!</a></span>
...
<li><b>1.</b>带有 <font color=red>*</font> 的为必填项，请认真填写。</li>
<li><b>2.</b>网站简介和logo地址为选填项，但需注意，只有填写了网站简介才有机会申请图文链接；只有填写了logo地址才有机会申请图片链接，但最终的链接类型还取决于本站的设置。</li>
<li><b>3.</b>申请链接请先在贵站的首页做好本站的友情链接。</li>
</ul>
</div>
</div>
