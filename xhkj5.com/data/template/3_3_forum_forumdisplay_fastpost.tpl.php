...
0
|| checktplrefresh('./template/comiis_nby/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1524238155, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_nby', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/comiis_nby/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1524238155, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_nby', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/comiis_nby/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1524238155, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_nby', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/comiis_nby/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1524238155, '3', './data/template/3_3_forum_forumdisplay_fastpost.tpl.php', './template/comiis_nby', 'forum/forumdisplay_fastpost')
;?>
...
<div class="cl">
<?php if($_G['uid'] && $_G['setting']['fastsmilies']) { ?><div id="fastsmiliesdiv" class="y"><div id="fastsmiliesdiv_data"><div id="fastsmilies"></div></div></div><?php } ?>
<div<?php if($_G['uid'] && $_G['setting']['fastsmilies']) { ?> class="hasfsl"<?php } ?> id="fastposteditor">
<div class="tedt">
<div class="bar">
<span class="y">
