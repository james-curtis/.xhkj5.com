<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); if(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle_'.$_G['fid']]) { if(!$subforumonly) { ?>
...
<script src="template/xhkj5.com_iuni/touch/images/js/jquery.masonry.min.js" type="text/javascript"></script>
