...
0
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/header.htm', 1524340542, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', 'data/diy/./template/default/', 'mobile/forum/discuz')
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/footer.htm', 1524340542, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', 'data/diy/./template/default/', 'mobile/forum/discuz')
;?>
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> 手机版 - www.xhkj5.com</title>
<style type="text/css">
...
<p>Powered by <strong><a href="http://www.xhkj5.com" target="_blank">Xunhuan</a></strong></p>
