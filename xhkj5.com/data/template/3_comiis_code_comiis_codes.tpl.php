...
<img src="http://s.jiathis.com/qrcode.php?url={$comiis_url}" />
...
<ul>
<li class="comiis_txt1ymky">{$plugindata['comiis_code_title']}</li>
<li class="comiis_txt2cdum">{$plugindata['comiis_code_views']}</li>
<li class="comiis_txt3yyjy"><A href="{$plugindata['comiis_code_link']}" target="_blank">{$plugindata['comiis_code_linktitle']}</A></li>
</ul>
