...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1524240425, '3', './data/template/3_3_member_login.tpl.php', './template/comiis_nby', 'member/login')
