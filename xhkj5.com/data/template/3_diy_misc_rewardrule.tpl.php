<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('misc_rewardrule');
0
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/comiis_nby/common/header.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/comiis_nby/common/footer.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/default/common/header_common.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/comiis_nby/common/comiis_user.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/comiis_nby/common/comiis_navss.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/comiis_nby/common/header_qmenu.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
|| checktplrefresh('source/plugin/k_misign/template/default/misc_rewardrule.htm', './template/default/common/pubsearchform.htm', 1524856647, 'diy', './data/template/3_diy_misc_rewardrule.tpl.php', 'source/plugin/k_misign/template/default', 'misc_rewardrule')
;?>
...
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em>
        ...
        <a href="<?php echo $setting['pluginurl'];?>misc&operation=rewardrule">奖励规则</a>
...
<div class="bm bw0 cl">	
        	...
        	<div class="bm_c cl">
            	...
            	<p>基础奖励:&nbsp;<?php echo $setting['mincredit'];?>~<?php echo $setting['maxcredit'];?>&nbsp;<?php echo $_G['setting']['extcredits'][$setting['nrcredit']]['unit'];?><?php echo $_G['setting']['extcredits'][$setting['nrcredit']]['title'];?></p>

        	</div>

            <?php if($extreward_num) { ?>

            <div class="bm_h"><h2>前排奖励</h2></div>
...
<tbody>
                    ...
                    <?php if(is_array($extrewardlist)) foreach($extrewardlist as $key => $extreward) { ?><tr>

                        	<td class="icn">&nbsp;</td>

                            <td class="frm"><?php echo $extreward['ul'];?></td>

                            <td>&nbsp;<?php echo $extreward['number'];?>&nbsp;<?php echo $_G['setting']['extcredits'][$extreward['type']]['unit'];?><?php echo $_G['setting']['extcredits'][$extreward['type']]['title'];?></td>
            ...
            <?php if($setting['lastedstatus']) { ?>

            <div class="bm_h"><h2>连续签到规则</h2></div>
...
<tbody>
                    ...
                    <?php if(is_array($lastrewardlist)) foreach($lastrewardlist as $key => $lastreward) { ?><tr>

                        	<td class="icn">&nbsp;</td>

                            <td class="frm"><?php echo $lastreward['lastday'];?>天</td>

                            <td>

                            <?php if(is_array($lastreward['reward'])) foreach($lastreward['reward'] as $lreward) { ?>                            <?php echo $lreward['number'];?>&nbsp;<?php echo $_G['setting']['extcredits'][$lreward['type']]['unit'];?><?php echo $_G['setting']['extcredits'][$lreward['type']]['title'];?>;

                            <?php } ?>

                            </td>

                            <td class="frm"><?php echo $medallist[$lastreward['relatedmedal']]['name'];?><?php if($lastreward['relatedmedaldate']) { ?>&nbsp;(&nbsp;<?php echo $lastreward['relatedmedaldate'];?>&nbsp;天&nbsp;)&nbsp;<?php } ?></td>
