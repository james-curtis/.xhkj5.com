...
<span class="o y">
<img src="template/xhkj5.com_iuni/touch/images/img/collapsed_<?php if(!$_G['setting']['mobile']['mobileforumview']) { ?>yes<?php } else { ?>no<?php } ?>.png?t">
</span>
...
obj.find('img').attr('src', 'template/xhkj5.com_iuni/touch/images/img/collapsed_yes.png');
} else {
subobj.css('display', 'none');
obj.find('img').attr('src', 'template/xhkj5.com_iuni/touch/images/img/collapsed_no.png');
}
});
 })();
</script>
