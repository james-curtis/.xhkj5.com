...
<div class="wp comiis_copyright cl">
	...
	Powered by <a href="http://www.xhkj5.com" target="_blank">讯幻网</a>  &copy; 2008-2017 <a href="$_G['setting']['siteurl']" target="_blank">$_G['setting']['sitename']</a> 版权所有 <!--{if $_G['setting']['icp']}--><a href="http://www.miitbeian.gov.cn/" rel="nofollow" target="_blank">$_G['setting']['icp']</a><!--{/if}--> <!--{if $_G['setting']['site_qq']}--><a href="http://wpa.qq.com/msgrd?V=3&uin=$_G['setting']['site_qq']&Site=$_G['setting']['bbname']&Menu=yes&from=discuz" rel="nofollow" target="_blank" title="QQ">客服QQ: {$_G['setting']['site_qq']}</a><!--{/if}-->
	&nbsp;技术支持: <A href="http://www.xhkj5.com" target="_blank" title="讯幻网">讯幻网</A>	<!--{hook/global_footerlink}-->
</div>
