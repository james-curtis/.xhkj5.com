...
$sql = <<<EOF
CREATE TABLE IF NOT EXISTS `pre_plugin_ljwenwentype` (
...
$sql = <<<EOF
INSERT INTO `pre_plugin_ljwenwentype` (`id`, `upid`, `subid`, `subject`, `displayorder`) VALUES
(1, 0, '', '$installlang[install1]', 0),
(2, 0, '', '$installlang[install2]', 0),
(3, 0, '', '$installlang[install3]', 0),
(4, 0, '', '$installlang[install4]', 0),
(5, 0, '', '$installlang[install5]', 0),
(6, 0, '', '$installlang[install6]', 0),
(7, 0, '', '$installlang[install7]', 0),
(8, 0, '', '$installlang[install8]', 0),
(9, 0, '', '$installlang[install9]', 0),
(10, 0, '', '$installlang[install10]', 0),
(11, 0, '', '$installlang[install11]', 0),
(12, 0, '', '$installlang[install12]', 0),
(13, 0, '', '$installlang[install13]', 0),
(14, 0, '', '$installlang[install14]', 0);
EOF;
runquery($sql);
