...
function trend_data_count(){
	...
	$view_info['data_types'] = $_POST['data_types'] ? $_POST['data_types'] : array(1, 2);
	$view_info['search_types'] = $_POST['search_types'] ? $_POST['search_types'] : array(1);
	$view_info['view_types'] = $_POST['view_types'] ? $_POST['view_types'] : array(1);
