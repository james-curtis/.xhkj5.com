...
class table_yinxingfei_thinfellpay_vip extends discuz_table
{
	public function __construct() {

		$this->_table = 'yinxingfei_thinfellpay_vip';
		$this->_pk    = '';
    ...
    public function fetch_all_by_sql($start, $limit) {
        return DB::fetch_all('SELECT * FROM %t ORDER BY adddate DESC'.DB::limit($start, $limit), array($this->_table), $this->_pk);
    }
    public function fetch_ordercompleted_data($showNumber=0)
	{
