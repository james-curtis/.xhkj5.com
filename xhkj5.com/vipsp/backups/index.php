...
<div class="container">
<div class="logo">
<a href="/" target="_self"><img src="style/img/logo.png">
</a>
</div>
...
<li><a href="http://vip.xhkj5.com/"><i></i>全网VIP视频免费在线看 - 讯幻网</a></li>
</ul>
</div>
</div>
    <br />
    ...
    <section style=" border: 8px solid rgb(255, 255, 255); box-shadow: rgb(230, 230, 220) 0px 1px 2px 2px; border-radius: 0; background-color: rgba(255, 255, 255, 0.6);">
        <p style="text-align: center;">
            <img style="border-top-left-radius: 2%; border-top-right-radius: 2%; vertical-align: middle; display: inline; width: 100%; visibility: visible !important;" src="http://www.xhkj5.com/tpwj/vipsp/1.jpg" width="100%" height="" border="0" mapurl="" title="" alt="">
        </p>
...
<br>
			...
			<div class="input-group" style="width: 100%;">
            	<select class="form-control input-lg" name="jk">
						...
						foreach($apijk as $k=>$v){
							...
							echo '<option value="'.$k.'"';if(intval($_GET['jk'])==$k){echo ' selected="selected"';}
							echo '>'.$apiname.'</option>';
						}
						?>
                	</select>
		...
		<div class="col-md-7" style="margin-top: 8px;">
          <div class="input-group" style="width: 100%;">
            <input class="form-control input-lg" type="text" name="url" placeholder="输入播放地址"></div></div>
          <div>
...
<h4>请记住我们的网址：<a href="http://vip.xhkj5.com/">vip.xhkj5.com</a></h4>
<h4>手机如果播放不了请用QQ浏览器</h4>
<h4>郑重声明：播放器内的所有广告并非本站所有，本站不承担播放器的广告所造成的一切后果</h4>
<h4><a href="http://www.xhkj5.com/" target="_blank">讯幻网提供</a></h4>'; 
		  }else{ 
